...
| Path | `resources/optional-skills/mlops/peft` |
| Version | `1.0.0` |
...
- **[Advanced Usage](https://github.com/NousResearch/hermes-agent/blob/main/resources/optional-skills/mlops/peft/references/advanced-usage.md)** - DoRA, LoftQ, rank stabilization, custom modules
- **[Troubleshooting](https://github.com/NousResearch/hermes-agent/blob/main/resources/optional-skills/mlops/peft/references/troubleshooting.md)** - Common errors, debugging, optimization
