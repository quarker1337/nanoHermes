...
`resources/optional-mcps/` in the hermes-agent repo — presence in that directory means
...
Manifests live at
[`resources/optional-mcps/<name>/manifest.yaml`](https://github.com/NousResearch/hermes-agent/tree/main/resources/optional-mcps)
...
[`resources/optional-mcps/`](https://github.com/NousResearch/hermes-agent/tree/main/resources/optional-mcps).
