...
| File | What to add |
|------|-------------|
| `docs/site/docs/user-guide/messaging/newplat.md` | Full platform setup page |
| `docs/site/docs/user-guide/messaging/index.md` | Platform comparison table, architecture diagram, toolsets table, security section, next-steps link |
| `docs/site/docs/reference/environment-variables.md` | All NEWPLAT_* env vars |
| `docs/site/docs/reference/toolsets-reference.md` | hermes-newplat toolset |
| `docs/site/docs/integrations/index.md` | Platform link |
| `docs/site/sidebars.ts` | Sidebar entry for the docs page |
| `docs/site/docs/developer-guide/architecture.md` | Adapter count + listing |
| `docs/site/docs/developer-guide/gateway-internals.md` | Adapter file listing |
