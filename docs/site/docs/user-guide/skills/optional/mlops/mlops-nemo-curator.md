...
| Path | `resources/optional-skills/mlops/nemo-curator` |
| Version | `1.0.0` |
...
- **[Filtering Guide](https://github.com/NousResearch/hermes-agent/blob/main/resources/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ quality filters, heuristics
- **[Deduplication Guide](https://github.com/NousResearch/hermes-agent/blob/main/resources/optional-skills/mlops/nemo-curator/references/deduplication.md)** - Exact, fuzzy, semantic methods
