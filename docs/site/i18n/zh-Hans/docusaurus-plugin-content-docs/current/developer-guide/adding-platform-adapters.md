...
| 文件 | 需添加内容 |
|------|-------------|
| `docs/site/docs/user-guide/messaging/newplat.md` | 完整的平台设置页面 |
| `docs/site/docs/user-guide/messaging/index.md` | 平台对比表、架构图、toolset 表、安全章节、下一步链接 |
| `docs/site/docs/reference/environment-variables.md` | 所有 NEWPLAT_* 环境变量 |
| `docs/site/docs/reference/toolsets-reference.md` | hermes-newplat toolset |
| `docs/site/docs/integrations/index.md` | 平台链接 |
| `docs/site/sidebars.ts` | 文档页面的侧边栏条目 |
| `docs/site/docs/developer-guide/architecture.md` | 适配器数量 + 列表 |
| `docs/site/docs/developer-guide/gateway-internals.md` | 适配器文件列表 |
