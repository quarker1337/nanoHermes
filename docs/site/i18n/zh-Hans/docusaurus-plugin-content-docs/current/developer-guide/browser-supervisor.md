...
- `docs/site/docs/developer-guide/browser-supervisor.md` — 本文件
...
- 文档：`docs/site/docs/user-guide/features/browser.md`、`docs/site/docs/reference/tools-reference.md`、`docs/site/docs/reference/toolsets-reference.md`
