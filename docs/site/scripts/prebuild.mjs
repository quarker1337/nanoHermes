#!/usr/bin/env node
// Runs docs/site/scripts/extract-skills.py and generate-llms-txt.py before
// docusaurus build/start so that:
//   - docs/site/static/api/skills.json (lazy-fetched by src/pages/skills/index.tsx)
//   - docs/site/static/api/skills-meta.json (sidecar metadata for the Skills Hub)
//   - docs/site/static/llms.txt (agent-friendly short docs index)
//   - docs/site/static/llms-full.txt (full docs concat for LLM context)
