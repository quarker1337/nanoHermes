...
### Transport Layer (NEW)
- **Transport ABC** abstracts format conversion and HTTP transport from `runtime/hermes_runtime/run_agent.py` into `agent/transports/` ([#13347](https://github.com/NousResearch/hermes-agent/pull/13347))
