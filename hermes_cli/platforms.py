...
PLATFORMS: OrderedDict[str, PlatformInfo] = OrderedDict([
    ...
    ("dingtalk",       PlatformInfo(label="💬 DingTalk",        default_toolset="dingtalk-platform")),
    ("feishu",         PlatformInfo(label="🪽 Feishu",          default_toolset="feishu-platform")),
    ("wecom",          PlatformInfo(label="💬 WeCom",           default_toolset="wecom-platform")),
    ("wecom_callback", PlatformInfo(label="💬 WeCom Callback",  default_toolset="wecom-callback-platform")),
    ("weixin",         PlatformInfo(label="💬 Weixin",          default_toolset="weixin-platform")),
    ("qqbot",          PlatformInfo(label="💬 QQBot",           default_toolset="qqbot-platform")),
    ("yuanbao",        PlatformInfo(label="🤖 Yuanbao",         default_toolset="yuanbao-platform")),
