...
`docs/site/docs/developer-guide/adding-platform-adapters.md` for the full
...
| `docs/site/docs/reference/environment-variables.md` | All env vars for the platform |
