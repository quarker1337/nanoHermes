...
class TestParseReasoningConfig(unittest.TestCase):
    ...
    def _parse(self, effort):
        from hermes_runtime.cli import _parse_reasoning_config
...
class TestReasoningPreviewBuffering(unittest.TestCase):
    ...
    @patch("hermes_runtime.cli._cprint")
    @patch("hermes_runtime.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=50))
    ...
    @patch("hermes_runtime.cli.shutil.get_terminal_size", return_value=SimpleNamespace(columns=60))
