"""Tests for save_config_value() in runtime/hermes_runtime/cli.py — atomic write behavior."""
...
def _cli_module():
    ...
    # Keep parent-package attribute and sys.modules aligned after tests that
    # evict/reload hermes_runtime.cli.
    hermes_runtime.cli = cli_mod
    return cli_mod
...
class TestSaveConfigValueAtomic:
    ...
    def config_env(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(_cli_module(), "_hermes_home", hermes_home)
        return config_path
    ...
    def test_calls_roundtrip_yaml_update(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("hermes_runtime.utils.atomic_roundtrip_yaml_update", mock_update)

        _cli_module().save_config_value("display.skin", "mono")
    ...
    def test_preserves_existing_keys(self, config_env):
        ...
        _cli_module().save_config_value("agent.max_turns", 50)
    ...
    def test_creates_nested_keys(self, config_env):
        ...
        _cli_module().save_config_value("auxiliary.compression.model", "google/gemini-3-flash-preview")
    ...
    def test_overwrites_existing_value(self, config_env):
        ...
        _cli_module().save_config_value("display.skin", "ares")
    ...
    def test_preserves_env_ref_templates_in_unrelated_fields(self, config_env):
        ...
        _cli_module().save_config_value("model.default", "doubao-pro")
    ...
    def test_file_not_truncated_on_error(self, config_env, monkeypatch):
        ...
        monkeypatch.setattr("hermes_runtime.utils.atomic_roundtrip_yaml_update", exploding_write)

        result = _cli_module().save_config_value("display.skin", "broken")
