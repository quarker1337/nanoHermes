...
class TestRunConversationSurrogateSanitization:
    ...
    @patch("hermes_runtime.run_agent.AIAgent._build_system_prompt")
    @patch("hermes_runtime.run_agent.AIAgent._interruptible_streaming_api_call")
    @patch("hermes_runtime.run_agent.AIAgent._interruptible_api_call")
