...
def cli_obj(_isolate):
    ...
    with patch("hermes_runtime.cli.load_cli_config", return_value={
        "display": {"tool_progress": "new"},
        "terminal": {},
    }), patch("hermes_runtime.cli.get_tool_definitions", return_value=[]), \
         patch("hermes_runtime.cli.build_welcome_banner"):
...
class TestLowContextWarning:
    ...
    def test_warning_for_below_minimum_context(self, cli_obj):
        ...
        with patch("hermes_runtime.cli.get_tool_definitions", return_value=[]), \
             patch("hermes_runtime.cli.build_welcome_banner"):
            cli_obj.show_banner()
    ...
    def test_compact_banner_does_not_crash_on_narrow_terminal(self, cli_obj):
        ...
        with patch("shutil.get_terminal_size", return_value=os.terminal_size((70, 40))), \
             patch("hermes_runtime.cli._build_compact_banner", return_value="compact banner"):
            cli_obj.show_banner()
