...
def main():
    ...
    print(f"   python -m hermes_runtime.batch_runner \\")
    ...
    print(f"   python -m hermes_runtime.batch_runner --list_distributions")
    
    print(f"\n🔍 After running, you can verify output with:")
    print(f"   python tests/test_runtime/hermes_runtime/batch_runner.py --verify")
