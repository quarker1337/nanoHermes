...
class TestStreamingAccumulator:
    ...
    @patch("hermes_runtime.run_agent.AIAgent._create_request_openai_client")
    @patch("hermes_runtime.run_agent.AIAgent._close_request_openai_client")
...
class TestAnthropicStreamCallbacks:
    ...
    @patch("hermes_runtime.run_agent.AIAgent._replace_primary_openai_client")
...
class TestPartialToolCallWarning:
    ...
    text was already delivered, the partial-stream stub at runtime/hermes_runtime/run_agent.py
...
class TestCodexFallbackErrorEvent:
    ...
    def test_fallback_raises_synthesized_error_with_xai_subscription_message(self):
        from hermes_runtime.run_agent import _StreamErrorEvent
    ...
    def test_fallback_surfaces_message_useful_to_summarizer(self):
        ...
        from hermes_runtime.run_agent import AIAgent, _StreamErrorEvent
