# infra/nix/checks.nix — Build-time verification tests
#
    ...
    in {
      ...
      checks = {
        ...
        bundled-tui = pkgs.runCommand "hermes-bundled-tui" { } ''
          ...
          test -d ${hermes-agent}/apps/tui || (echo "FAIL: apps/tui directory missing"; exit 1)
          echo "PASS: apps/tui directory exists"

          test -f ${hermes-agent}/apps/tui/dist/entry.js || (echo "FAIL: compiled entry.js missing"; exit 1)
