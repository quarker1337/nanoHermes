# infra/nix/hermes-agent.nix — Overridable Hermes Agent package
#
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    mkdir -p $out/apps/tui
    cp -r ${hermesTui}/lib/hermes-tui/* $out/apps/tui/
    ...
    ${lib.concatMapStringsSep "\n"
      (name: ''
        makeWrapper ${hermesVenv}/bin/${name} $out/bin/${name} \
          ...
          --set HERMES_TUI_DIR $out/apps/tui \
